...
export default function CreatePrompt() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                if (data.message?.includes("flagged")) {
                    alert(
                        "Your prompt contains inappropriate content and is pending moderator review."
                    );
                } else {
                ...
                alert(
                    `Failed to create prompt: ${data.error || "Unknown error"}`
                );
            }
        } catch (error) {
